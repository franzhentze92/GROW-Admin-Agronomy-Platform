...
BEGIN
    ...
    IF course_uuid IS NOT NULL THEN
        ...
        (course_uuid, 'Chapter 2: Cracking the Code – Introduction', 'Introduction to practical soil test interpretation and key parameters.', '5 min', 'reading', '{"readingContent": "Now that you understand the philosophy and purpose behind soil testing, it\'s time to roll up your sleeves and start interpreting the numbers..."}', 4, false, NOW(), NOW()),
