...
const GrowingDegreeDaysTool: React.FC<GrowingDegreeDaysToolProps> = ({ className }) => {
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      <div>
        <h1 className="text-3xl font-bold text-foreground">Growing Degree Days Tool</h1>
        <p className="text-muted-foreground mt-1">Use growing degree days to anticipate pest and disease development, optimize biofix timing, and improve risk management decisions for your crops.</p>
      </div>
