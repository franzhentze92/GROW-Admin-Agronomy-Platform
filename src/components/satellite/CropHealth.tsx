...
const CropHealth: React.FC = () => {
  ...
  const [selectedDay, setSelectedDay] = useState<string>(() => cropHealthData.length > 0 ? cropHealthData[cropHealthData.length - 1].date : '');
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Farm, Paddock, Date Range, and Apply Button Row (merged) */}
      ...
      <div className="mb-4 bg-white p-3 rounded-xl shadow-sm flex flex-wrap gap-6 items-end justify-center">
        ...
        <div className="flex flex-col flex-1 min-w-[220px]">
          <label className="text-sm font-medium mb-1">Select Day</label>
