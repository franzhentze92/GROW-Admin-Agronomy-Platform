...
const API_URL = 'https://mushroom.kindwise.com/api/v1/identification'; // <-- Replace with actual endpoint if different
const MUSHROOM_API_KEY = 'fyPy4Cp64yrM37h92Ao1CPpobivGXduURLe7qyy6270Ygh9bJ9'; // <-- Replace with actual mushroom.id API key

const MushroomIDPage: React.FC = () => {
  ...
  const handleIdentify = async () => {
    ...
    try {
      ...
      setError(err.message || 'Failed to identify mushroom');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="w-full min-h-screen bg-muted py-10">
      <div className="max-w-6xl mx-auto px-4">
        <h1 className="text-4xl font-bold mb-1">Mushroom ID</h1>
        <div className="text-muted-foreground text-lg mb-6 font-normal">
          Use this tool to identify mushroom species from a photo and get more information about your sample.
        </div>
        {/* Controls Card */}
        ...
        {!imagePreview && (
          <div className="bg-white rounded-xl shadow p-6 mb-6 flex flex-col items-center">
            <img
              src="https://images.unsplash.com/photo-1550824730-05ededc35e7a?q=80&w=1333&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Demo preview"
