...
const SatelliteImageryPage: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-foreground">Satellite Imagery</h1>
        <p className="text-muted-foreground mt-1">Analyze crop health, vegetation indices, and field conditions using high-resolution satellite imagery.</p>
      </div>
