...
const ChatPage: React.FC = () => {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">G-Man Chat</h1>
        <p className="text-muted-foreground mt-1">Your personal AI assistant, the G-Man, for agronomy, crop nutrition, and soil health.</p>
      </div>
