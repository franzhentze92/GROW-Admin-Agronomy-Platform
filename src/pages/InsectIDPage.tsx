...
const API_URL = 'https://insect.kindwise.com/api/v1/identification';
const INSECT_API_KEY = 'W4GMFawwl0fFZhoprP5AN89hGZPONEIOvtMzXpZHfcQWSW46qy';

const InsectIDPage: React.FC = () => {
  ...
  const handleIdentify = async () => {
    ...
    try {
      ...
      setError(err.message || 'Failed to identify insect');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        {!imagePreview && (
          <div className="bg-white rounded-xl shadow p-6 mb-6 flex flex-col items-center">
            <img
              src="https://images.unsplash.com/photo-1632677662272-6cd48367c073?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Demo preview"
