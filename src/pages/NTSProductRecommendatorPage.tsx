...
const NTSProductRecommendatorPage: React.FC = () => {
  return (
    <div className="container mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">NTS Product Recommendator</h1>
        <p className="text-muted-foreground mt-1">Find compatible NTS products and recommendations for your crop and situation.</p>
      </div>
      {/* Embedded Tool */}
